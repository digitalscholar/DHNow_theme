...
if ( ! function_exists( 'dhnow_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function dhnow_posted_on() {
...
if ( ! function_exists( 'dhnow_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'dhnow_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function dhnow_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'dhnow' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'dhnow_post_thumbnail' ) ) :
	/**
